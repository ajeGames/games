...
public class Picnic implements PersistedGameEntity {
  ...
  private void initialize(String key) {
    this.key = key;
    this.status = PicnicStatus.STAGING;
  ...
  public PicnicStatus getStatus() {
    return status;
  }

  public boolean isStaging() {
    return status.equals(PicnicStatus.STAGING);
  }

  public boolean isPlaying() {
    return status.equals(PicnicStatus.PLAYING);
  }

  public boolean isGameOver() {
    return status.equals(PicnicStatus.GAME_OVER);
  }
